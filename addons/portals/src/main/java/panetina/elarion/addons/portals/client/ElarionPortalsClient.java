...
public final class ElarionPortalsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ElarionHudOverlayRegistry.registerBeforeNotifications(PortalStatusHud::render);
        ElarionHudOverlayRegistry.registerAfterNotifications(PortalStatusHud::renderTooltip);
        ClientPlayConnectionEvents.DISCONNECT.register((handler, client) -> {
            PortalClientRouteStatus.clear();
            PortalClientVisuals.clear();
        });

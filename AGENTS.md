...
- `platform/core`: canonical Core systems, character lifecycle/archives,
  shared APIs, read-only config descriptor registry, shared UI, modular Collection menu, notification HUD rail/drawer, claimable reward
